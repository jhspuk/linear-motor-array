...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB12     ------> ADC1_IN11
    */
    GPIO_InitStruct.Pin = VM_ADC_Pin|Motor_Current_Sensing_Pin;
  ...
  */
    ...
    PB11     ------> ADC2_IN14
    */
    GPIO_InitStruct.Pin = First_Stage_ADC_Pin|Second_Stage_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(GPIOB, VM_ADC_Pin|Motor_Current_Sensing_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB11     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOA, First_Stage_ADC_Pin|Second_Stage_ADC_Pin);

    HAL_GPIO_DeInit(Hall_effect_GPIO_Port, Hall_effect_Pin);
